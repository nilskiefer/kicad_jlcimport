...
CATEGORIES = [
    ...
    "Delay Lines",
    "Desktop Computers",
    "Desoldering Pump / Desoldering Wire",
    "Desoldering Tools",
    "Detectors & Scanners",
    ...
    "JFETs",
    "Jacks, Plugs",
    "Jumper Wire & Pre-Crimped Lead Assemblies",
    ...
    "Socket Accessories",
    "Socket Adapters",
    "Socket,Screwdriver Accessories",
    "Sockets",
    ...
    "Wipes",
    "Wire Ducts, Raceways",
    "Wire Ducts, Raceways Management",
    "Wire Pin Connectors",
    "Wire Pin Terminal",
